...
// 📚 Offline FRA Legal Knowledge Base (Fallback)
const FRA_KNOWLEDGE_BASE = [
  ...
  },
  {
    ...
    answer: "FRA Section 6 mandates that the Gram Sabha is the authority to initiate the process for determining forest rights. Recommendations go to Sub-Divisional Level Committee (SDLC) → District Level Committee (DLC). [Source: FRA 2006, Sec 6]"
  },
  {
  ...
  {
    question: /default/i,
    answer: "I specialize in India's Forest Rights Act 2006. Ask me about Section 3 rights, Section 6 process, rejected claims, community rights, or how to file. I’ll give you exact legal provisions with citations. Example: 'What is Section 3(1)(a)?'"
  }
];
...
const ChatBot = ({ selectedClaim }) => {
  const [messages, setMessages] = useState([
    {
      text: "🌿 Hello! I'm your FRA Legal Assistant powered by Gemini AI. Ask me about Forest Rights Act provisions, claim processes, or legal remedies — I’ll give you accurate, cited answers.",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
